...
function populateDropDown(ele,Editable){
var x, i, j, l, ll, selElmnt, a, b, c;
/* Look for any elements with the class "custom-select": */
  selElmnt = ele.getElementsByTagName("select")[0];
  ll = selElmnt.length;
  ...
  for (j = 1; j < ll; j++) {
    ...
    k.innerHTML = selElmnt.options[j].innerHTML;
    c.appendChild(k);
    ...
    c.addEventListener("click", function(e) {
        ...
        for (i = 0; i < sl; i++) {
          if (s.options[i].innerHTML == innerhtmltext) {
            s.selectedIndex = i;
...
populateDropDown($(".customDropDown")[0],false);
